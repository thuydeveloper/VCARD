    ...
    <div class="container p-0">
        ...
        <div
            ...
            <div class="profile-section pb-40 px-30">
                ...
                @endif
                @if(getLanguage($vcard->default_language) == 'Arabic')
                    <div class="card flex-sm-row" dir="rtl">
                        <div class="card-img d-flex justify-content-center align-items-center">
                        <img src="{{ $vcard->profile_url }}" class="w-100 h-100" loading="lazy"/>
                        </div>
                        <div class="card-body px-0">
                                ...
                                @if ($vcard->alternative_phone)
                                    <div class="col-sm-6 mb-40">
                                        <div class="contact-box">
                                            ...
                                            <a href="tel:+{{ $vcard->alternative_region_code }} {{ $vcard->alternative_phone }}" class="text-white">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pb-40 px-30 mt-3"  @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="row justify-content-between">
                        <div class="col-md-7 col-sm-6">
                            <div class="section-heading text-start overflow-hidden mb-4">
                                <h2 class="text-white mb-0 d-inline-block">
                        ...
                        <div class="col-md-5 col-sm-6 d-sm-block d-none">
                            <div
                                ...
                                <div class="qr-code-img d-flex justify-content-center align-items-center" id="qr-code-twelve">
            ...
            @if ((isset($managesection) && ($managesection['products'])) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section bg-gray pb-40 px-3">
                        <div class="section-heading text-start overflow-hidden mx-3">
                            <h2 class="text-white mb-0 d-inline-block">
                                ...
                                <div class="">
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="product-card card">
                                            ...
                                            <img src="{{ $product->product_icon }}" class="img-fluid h-100 w-100" loading="lazy"/>
                                            </div>
                        ...
                        <div class="text-center mt-4">
                            <a class="fs-6 mb-0  text-decoration-underline  text-primary " href="{{ route('showProducts',['id'=>$vcard->id,'alias'=>$vcard->url_alias]) }}">{{__('messages.analytics.view_more')}}</a>
                        </div>
                    </div>
                @endif
            @endif
            ...
            @if ((isset($managesection) && ($managesection['testimonials'])) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pb-4" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class=" bg-black position-relative">
                            <div class="quote-img">
                                <img src="{{ asset('assets/img/vcard12/quote-img.png') }}" class="h-100" loading="lazy"/>
                            </div>
                            <div class="bg-img">
                                <img src="{{ asset('assets/img/vcard12/testimonial-bg.png') }}" loading="lazy"/>
                            </div>
                                    ...
                                    <div class="">
                                        <div class="testimonial-card h-100">
                                            <div
                                                ...
                                                <div
                                                    class="d-flex align-items-center justify-content-sm-start justify-content-center" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            <div class="" >
                ...
                <div class="nav nav-tabs px-0 border-0 d-flex justify-content-around" id="nav-tab" role="tablist">
                    <button class="d-flex align-items-center justify-content-center py-2 active postbtn instagram-btn border-0" id="nav-home-tab"
                    ...
                    <button class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn border-0" id="nav-profile-tab" data-bs-toggle="tab"
                                    ...
                                    <div class="blog-card blog-1 card">
                                        <div class="overlay">
                                            ...
                                            <div class="card-body d-flex flex-column justify-content-end">
                                                <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                                                    <h4 class="card-title text-white fw-5 fs-20">{{ $blog->title }}</h4>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
            ...
            @if ((isset($managesection) && ($managesection['business_hours'])) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                        <div class="bussiness-hour-section pt-30 px-30 pb-30"  @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <div class="section-heading text-center overflow-hidden">
                            <h2 class="text-white mb-0 d-inline-block">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pb-30 mt-1 px-30">
                    <div class="section-heading text-center overflow-hidden">
                        <h2 class="text-white mb-0 d-inline-block">
                        ...
                        <div class="contact-form pt-3 mt-3 position-relative">
                            <form action="" id="enquiryForm">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                        <label class="text-white mb-1">{{ __('messages.form.your_name') }} <span class="text-danger">*</span></label>
                                            <input type="text" name="name" class="form-control"
                                                placeholder="{{ __('messages.form.your_name') }}" />
                                        </div>
                                        <div class="mb-3">
                                        <label class="text-white mb-1">{{ __('messages.form.your_email') }} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                        <label class="text-white mb-1">{{ __('messages.user.your_message') }} <span class="text-danger">*</span></label>
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                {{-- create vcard --}}
                <div class="create-vcard-section px-30 pb-30 pt-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="section-heading text-start overflow-hidden">
                        <h2 class="text-white mb-0 d-inline-block">
