    ...
    <div class="row d-flex justify-content-center">
        <div class="main-bg p-0">
            ...
            <div class="position-relative">
                <img src="{{asset('assets/img/vcard7/bannerimg.png')}}" class="banner-img" loading="lazy"/>
                        ...
                        <div class="row">
                            <div class="col-sm-6 mb-4">
                                <div class="card border-0 bg-transparent">
                                    <div class="event-icon text-center">
                                        <div>
                                            <img src="{{asset('assets/img/vcard7/email.png')}}" class="img-fluid mb-2" loading="lazy"/>
                                        </div>
                            ...
                            <div class="col-sm-6 mb-4">
                                <div class="card border-0 bg-transparent">
                                    <div class="event-icon text-center">
                                        <div>
                                            <img src="{{asset('assets/img/vcard7/phone.png')}}" class="img-fluid mb-2" loading="lazy"/>
                                        </div>
                            ...
                            <div class="col-sm-6 mb-4">
                                <div class="card border-0 bg-transparent">
                                    <div class="event-icon text-center">
                                        <div>
                                            <img src="{{asset('assets/img/vcard7/cake.png')}}" class="img-fluid mb-2" loading="lazy"/>
                                        </div>
                ...
                <div class="our-service-section">
                    <div class="row">
                        <div class="col-12 mb-4">
                            <div class="our-service-info d-flex align-items-center">
                                <div class="our-service-img me-3 rounded-circle">
                                    <img src="{{asset('assets/img/vcard7/design.png')}}" loading="lazy"/>
                                </div>
                                <div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="our-service-info d-flex align-items-center">
                                <div class="our-service-img me-3 rounded-circle">
                                    <img src="{{asset('assets/img/vcard7/ui.png')}}" loading="lazy"/>
                                </div>
                                <div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="our-service-info d-flex align-items-center">
                                <div class="our-service-img me-3 rounded-circle">
                                    <img src="{{asset('assets/img/vcard7/app.png')}}" loading="lazy"/>
                                </div>
                                <div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="our-service-info d-flex align-items-center">
                                <div class="our-service-img me-3 rounded-circle">
                                    <img src="{{asset('assets/img/vcard7/website.png')}}" loading="lazy"/>
                                </div>
                                <div>
                                        ...
                                        <a href="javascript:void(0)" data-bs-toggle="modal"
                                           ...
                                           class="gallery-link">
                                            <img src="https://vcard.waptechy.com/assets/img/video-thumbnail.png"
                                                 alt="profile" class="w-100" loading="lazy"/>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center testimonial-box">
                                        <img src="{{asset('assets/img/vcard7/testilogo.png')}}"
                                             class="testi-logo rounded-circle" loading="lazy"/>
                                        <div class="my-2">
                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-6">
                            <div class="text-center mb-4">
                                <img src="{{asset('assets/img/qrcode.png')}}" class="qr-img" loading="lazy"/>
                            </div>
                        </div>
                        <div class="col-lg-6">
            ...
            <div class="container mt-3 mb-3">
                <div class="contactus-section position-relative">
                    <h3 class="text-center mb-4">Inquiries</h3>
