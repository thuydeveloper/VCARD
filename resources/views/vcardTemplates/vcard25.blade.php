...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            {{-- profile detials --}}
            <div class="profile-section px-30" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                <div class="profile-bg-img">
                    <img src="{{ asset('assets/img/vcard25/profile-bg-img.png') }}" loading="lazy"/>
                </div>
                <div class="card d-flex flex-sm-row align-items-sm-start align-items-center mb-sm-4 mb-3 pb-sm-2"  @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="testimonial-section pt-60 pb-5">
                        ...
                        <div class="testimonial-slider pt-60 pb-40 px-40">
                            @foreach ($vcard->testimonials as $testimonial)
                                <div class="">
                                    <div class="testimonial-card card flex-sm-row" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            <div class="btn-section cursor-pointer @if(getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div class="bars-btn social-services-bars-btn @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard25/sticky.png') }}" loading="lazy"/>
                        </div>
                    @endif
