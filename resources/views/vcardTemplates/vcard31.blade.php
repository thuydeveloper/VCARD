    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
           {{-- support banner --}}
               ...
               <div class="support-banner d-flex align-items-center justify-content-center">
                   ...
                   <div class="">
                       ...
                       <div class="text-center mt-3">
                           <a href="{{ $banners->url }}" class="act-now text-white" target="blank" data-turbo="false">{{ $banners->banner_button }}</a>
                       </div>
                   </div>
               </div>
            @endif
            ...
            {{-- profile section --}}
            <div class="profile-section px-30 mb-1" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            <div class="contact-section pt-4 px-30">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-4 pb-sm-2">
                        <div class="contact-box d-flex align-items-center">
                            <div class="contact-icon d-flex justify-content-center align-items-center me-3">
                                <img src="{{ asset('assets/img/vcard31/email.png') }}" />
                            </div>
                    ...
                    <div class="col-sm-6 mb-4 pb-sm-2">
                        <div class="contact-box d-flex align-items-center">
                            <div class="contact-icon d-flex justify-content-center align-items-center me-3">
                                <img src="{{ asset('assets/img/vcard31/phone.png') }}" />
                            </div>
                            <div class="contact-desc">
                                <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-secondary fs-6 fw-5">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-sm-6 mb-4 pb-sm-2">
                        <div class="contact-box d-flex align-items-center">
                            ...
                            <div class="contact-desc">
                                <a href="tel:+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}" class="text-secondary fs-6 fw-5">+{{ $vcard->alternative_region_code }}{{ $vcard->alternative_phone }}</a>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-sm-6 mb-sm-0 mb-4">
                        <div class="contact-box d-flex align-items-center">
                            <div class="contact-icon d-flex justify-content-center align-items-center me-3">
                                <img src="{{ asset('assets/img/vcard31/dob.png') }}" />
                            </div>
                            <div class="contact-desc">
                    ...
                    <div class="col-sm-6">
                        <div class="contact-box d-flex align-items-center">
                            <div class="contact-icon d-flex justify-content-center align-items-center me-3">
                                <img src="{{ asset('assets/img/vcard31/location.png') }}" />
                            </div>
                            <div class="contact-desc">
                    ...
                    <div class="row  services-slider-view">
                        ...
                        <div class="col-sm-6 mb-sm-0 mb-40 mt-4">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <div class="card-img d-flex ">
                                        <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                            ...
                                            <img src="{{ $service->service_icon }}" alt="branding" loading="lazy" class="h-100 w-100 object-fit-cover"/>
                                        </a>
                                    </div>
                                ...
                                <div class="card-body p-0">
                                    <p class="mb-0 fs-14 text-gray-100 {{ \Illuminate\Support\Str::length($service->description) > 80 ? 'more' : '' }}">
                                        {!! $service->description !!}
                                    </p>
                                </div>
                            </div>
            ...
            <div class="appointment-section pt-60 px-30">
                ...
                <div class="appointment">
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <div class="mb-20">
                                        <label class="text-secondary fs-6 fw-5 mb-1 text-start">{{ __('messages.date') }}
                                            :</label>
                                    ...
                                    <label class="text-secondary fs-6 fw-5 mb-1 text-start">{{ __('messages.hour') }}:</label>
                                <div class="row m-0">
                                    <div class="">
                                ...
                                <div class="mt-2 text-center">
                                    <button class="appointmentAdd btn btn-primary w-100 rounded-2">
                            ...
                            <div class="product-card card justify-content-end">
                                {{-- <div class="product-img card-img"> --}}
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        target="_blank" class="text-decoration-none fs-6 position-relative d-block h-100">
                                       <div class="card-img">
                                        <img
                                            src="{{ $product->product_icon }}"
                                            class="w-100 h-100 object-fit-contain" loading="lazy">
                                    </div>
                                    <div class="product-desc align-items-center desc-div">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <h3 class="text-secondary fs-6 fw-5 mb-0 product-name">{{ $product->name }}</h3>
                        ...
                        <div class="testimonial-card card">
                            ...
                            <div class="card-body p-0 pt-5">
                                <div class="text-center">
                                    ...
                                    <p class="desc text-gray-100 fs-14 mb-0 {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
                    ...
                    <form action="" id="enquiryForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 mb-3">
                                <input type="text" class="form-control" placeholder="{{ __('messages.form.your_name') }}" name="name" />
                            </div>
                            <div class="col-sm-6 mb-3">
                                <input type="email" class="form-control" placeholder="{{ __('messages.form.your_email') }}"  name="email" />
                            </div>
                            <div class="col-12 mb-3">
                                <input type="tel" class="form-control" placeholder="{{ __('messages.form.phone') }}" name="phone"/>
                            </div>
                            <div class="col-12 mb-3">
                                <textarea class="form-control h-100" placeholder="{{ __('messages.form.type_message') }}" name="message" rows="4"></textarea>
                            </div>
            ...
            <div class="btn-section cursor-pointer  @if(getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                ...
                <div class="bars-btn handyman-bars-btn @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                    <img src="{{ asset('assets/img/vcard31/sticky.png') }}" />
                </div>
                @endif
