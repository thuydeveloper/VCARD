        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
            <div class="banner-section position-relative">
                <div class="banner-img">
                    <img src="{{ asset('assets/img/vcard28/banner-img.png') }}" class="w-100 h-100 object-fit-cover"
                        alt="banner-img" />
                </div>
            ...
            <div class="profile-section px-30">
                ...
                <div class="card d-flex flex-sm-row align-items-sm-end align-items-center mb-40 pt-4">
                    <div class="card-img">
                        <img src="{{ asset('assets/img/vcard28/profile-img.png') }}"
                            class="w-100 h-100 object-fit-cover" />
                    </div>
                    <div class="card-body p-0 text-sm-start text-center">
                        <div class="profile-name">
                            <h2 class="text-black mb-0 fs-30">Richard Madden</h2>
                            <p class="fs-18 text-purple mb-0">Pet Clinic</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6 mb-4">
                        <div class="contact-box d-flex align-items-center">
                            <div class="contact-icon d-flex justify-content-center align-items-center bg-purple-light">
                    ...
                    <div class="col-sm-6 mb-4">
                        <div class="contact-box d-flex align-items-center">
                            <div class="contact-icon d-flex justify-content-center align-items-center bg-yellow-light">
                    ...
                    <div class="col-sm-6 mb-sm-0 mb-4">
                        <div class="contact-box d-flex align-items-center">
                            <div class="contact-icon d-flex justify-content-center align-items-center bg-pink-light">
                    ...
                    <div class="col-sm-6">
                        <div class="contact-box d-flex align-items-center">
                            <div class="contact-icon d-flex justify-content-center align-items-center bg-blue-light">
                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-sm-0 mb-5">
                            <div class="service-card h-100">
                                <div class="card-img">
                                    <img src="{{ asset('assets/img/vcard28/service-img1.png') }}" />
                                </div>
                                <div class="card-body text-center p-0">
                                    <h3 class="card-title fs-18 text-black mb-10">
                                        Walking & Sitting
                                    </h3>
                                    <p class="mb-0 fs-14 text-gray-500 text-center">
                        ...
                        <div class="col-sm-6">
                            <div class="service-card h-100">
                                <div class="card-img">
                                    <img src="{{ asset('assets/img/vcard28/service-img2.png') }}" />
                                </div>
                                <div class="card-body text-center p-0">
                                    <h3 class="card-title fs-18 text-black mb-10">
                                        Health & Wellness
                ...
                <div class="gallery-slider">
                    <div class="slide">
                        <div class="gallery-img">
                            <img src="{{ asset('assets/img/vcard28/gallery-img.png') }}" />
                        </div>
                    </div>
                    <div class="slide">
                        <div class="gallery-img">
                    ...
                    <div class="">
                        <div class="product-card card">
                            <div class="product-img card-img">
                                <img src="{{ asset('assets/img/vcard28/product-img1.png') }}" />
                            </div>
                            <div class="product-desc card-body p-3">
                                <h3 class="text-black fs-6 fw-5 mb-2">Pet Toy</h3>
                                <p class="fs-14 text-gray-500 mb-2">
                                    Black Hexa Dumbbells Set
                                </p>
                                <p class="amount fs-20 fw-6 mb-0 text-purple lh-1">$19.99</p>
                            </div>
                        </div>
                    </div>
                    <div class="">
                        <div class="product-card card">
                            <div class="product-img card-img">
                                <img src="{{ asset('assets/img/vcard28/product-img2.png') }}" />
                            </div>
                            <div class="product-desc card-body p-3">
                                <h3 class="text-black fs-6 fw-5 mb-2">Pet Toy</h3>
                                <p class="fs-14 text-gray-500 mb-2">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="d-flex align-items-center gap-3">
                                    <div class="testimonial-profile-img">
                                        <img src="{{ asset('assets/img/vcard28/testimonial-profile-img.png') }}"
                                            class="w-100 h-100 object-fit-cover" />
                                    </div>
                                    <div class="">
                                        <h3 class="text-pink fs-18">Home Visit</h3>
                                        <p class="fs-14 text-black mb-0">James Brown</p>
                                    </div>
                                </div>
                                <div class="quote-img">
                                    <img src="{{ asset('assets/img/vcard28/quote-img.png') }}" alt="quote"
                                        class="h-100" />
                                </div>
                            </div>
                            <div class="card-body p-0 pt-3">
                                <p class="desc text-gray-500 fs-12 mb-0">
                    ...
                    <div class="px-30">
                        <div class="testimonial-card card">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="quote-img">
                                    <img src="{{ asset('assets/img/vcard28/quote-img.png') }}" alt="quote" class="h-100" />
                                </div>
                            </div>
                            <div class="card-body p-0 pt-3">
                                <p class="desc text-gray-500 fs-12 mb-0">
            ...
            <div class="blog-section pt-60 px-3">
                ...
                <div class="blog-slider">
                    <div>
                        <div class="blog-card card">
                            <div class="card-img mb-3">
                                <img src="{{ asset('assets/img/vcard28/blog-img1.png') }}"
                                    class="w-100 h-100 object-fit-cover" />
                            </div>
                            <div class="card-body p-0">
                                <h2 class="fs-18 text-black">Pet Care</h2>
                    ...
                    <div>
                        <div class="blog-card card">
                            <div class="card-img mb-3">
                                <img src="{{ asset('assets/img/vcard28/blog-img2.png') }}"
                                    class="w-100 h-100 object-fit-cover" />
                            </div>
                            <div class="card-body p-0">
                                <h2 class="fs-18 text-black">Pet Care</h2>
            ...
            <div class="business-hour-section pt-60 px-30">
                ...
                <div class="">
                    <div class="business-hour-card row justify-content-center">
                        <div class="col-sm-6 mb-3">
                            <div class="business-hour text-center text-sm-start">
                                <span class="me-2">Sunday :</span>
                                <span>08:10 - 20:00</span>
                            </div>
                        </div>
                        <div class="col-sm-6 mb-3">
                            <div class="business-hour text-center text-sm-end">
            ...
            <div class="qr-code-section pt-60 px-30">
                ...
                <div class="qr-code d-flex justify-content-center align-items-center flex-wrap mb-30">
                    <div class="qr-profile-img">
                        <img src="{{ asset('assets/img/vcard28/qr-profile-img.png') }}"
                            class="w-100 h-100 object-fit-cover" />
                    </div>
                    <div class="qr-code-img">
                        <img src="{{ asset('assets/img/vcard28/qr-code-img.png') }}"
                            class="w-100 h-100 object-fit-cover" />
                    </div>
                </div>
            </div>
                    ...
                    <form action="">
                        <div class="row">
                            ...
                            <div class="col-12 text-center">
                                <button class="send-btn rounded-2 btn btn-pink" type="submit">
                                    Send Message
                                </button>
                            </div>
                        </div>
            ...
            <div class="create-vcard-section pt-60 pb-60 px-30 mb-2">
