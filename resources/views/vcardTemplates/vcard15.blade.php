...
<body>
    <div class="container p-0">
        ...
        @endif
        <div class="vcard-fifteen main-content mx-auto w-100 overflow-hidden  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- support banner --}}
                    ...
                    <div class="support-banner d-flex align-items-center justify-content-center">
                        ...
                        <div class="">
                            ...
                            <div class="text-center">
                                <a href="{{ $banners->url }}" class="act-now mb-4 text-light" target="blank" data-turbo="false">{{ $banners->banner_button }}</a>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="bg-primary">
                <div class="profile-section px-30 profile-border">
            ...
            @if (checkFeature('products') && $vcard->products->count())
                <div class="product-section bg-gray pt-30 pb-30 px-30">
                    ...
                    <div class="px-30">
                        <div class="testimonial-slider">
                            @foreach ($vcard->testimonials as $testimonial)
                                <div class="">
                                    <div class="testimonial-card d-flex flex-sm-row flex-column align-items-center" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                        <div class="card-img">
            ...
            <div class="blog-section pt-40 bg-gray-200">
                <div class=" text-center mb-40">
                    <h2 class="font-cormorant text-primary text-center mb-2">{{ __('messages.feature.insta_embed') }}</h2>
                    </div>
                <nav>
                            ...
                            <div class="">
                                <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                                    <div class="blog-card card">
                                        <div class="card-img">
                                            <img src="{{ $blog->blog_icon }}" class="w-100" loading="lazy"/>
                                        </div>
                                        <div class="card-body h-auto" style="min-height:auto!important">
                                            <h6 class="card-title text-primary fw-2 text-center"> {{ $blog->title }}</h6>
                                        </div>
                                    </div>
                                </a>
                            </div>
            ...
            @if ($vcard->businessHours->count())
                ...
                <div class="bussiness-hour-section pt-50 pb-60 px-30">
                    <h2 class="font-cormorant text-primary text-center pb-30">
            ...
            <div class="gallery-section pt-50  px-30">
                <h2 class="font-cormorant text-primary text-center mb-2">{{ __('messages.vcard.iframe') }}</h2>
                        ...
                        <div class="slide">
                            <div class="iframe-card">
                                <iframe src="{{ $iframe->url }}" frameborder="0"
                                    ...
                                    allowfullscreen width="100%" height="300" class="w-100" loading="lazy">
                                </iframe>
                            </div>
                        </div>
                    @endforeach
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 pb-40 px-30 mb-5">
                    <h2 class="font-cormorant text-primary text-center mb-0 pb-30">
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div class="bars-btn salon-bars-btn @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
