...
<body>
    <div class="container p-0">
        ...
        @endif
        <div class="main-content vcard w-100 mx-auto content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="vcard__banner w-100 position-relative">
                ...
                <video class="cover-video banner-image" loop autoplay muted playsinline  alt="background video" id="cover-video">
                            ...
                            @if ($vcard->alternative_email)
                                <div class="col-sm-6 col-12">
                                    <div
                                        class="card vcard__event-card d-flex flex-column justify-content-center align-items-center border-0 p-3 h-100">
                                        <span class="event-icon">
                                            <img src="{{ asset('img/vcard4/alter-image.png') }}"
                                                class="img-fluid" height="22" width="30" alt>
                                        </span>
                            ...
                            @if ($vcard->alternative_phone)
                                <div class="col-sm-6 col-12">
                                    <div
                                        class="card vcard__event-card d-flex flex-column justify-content-center align-items-center border-0 p-3 h-100">
                                        <span class="event-icon">
                                            <img src="{{ asset('img/vcard4/alter-phone.png') }}"
                                                class="img-fluid">
                                        </span>
                    ...
                    <div class="px-4 pt-5 pb-4">
                        ...
                        <div class="qr-code d-block mx-auto position-relative px-5 pt-5 pb-3">
                            <img src="{{ $vcard->profile_url }}"
                                class="qr-code-profile d-block mx-auto position-absolute top-0 start-50 translate-middle" loading="lazy"/>
            ...
            <nav>
                ...
                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                    <button class="d-flex align-items-center justify-content-center active postbtn instagram-btn fs-2 border-0 py-2" id="nav-home-tab"
                    ...
                    <button class="d-flex align-items-center justify-content-center instagram-btn reelsbtn fs-2 border-0 py-2" id="nav-profile-tab" data-bs-toggle="tab"
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="vcard__timing mb-10 mt-0">
                        <div class="px-4 hours-section">
                            <h4 class="vcard__heading text-center pb-4">{{ __('messages.business.business_hours') }}</h4>
                            <div class="row g-3 mx-sm-4"  @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="px-4 mb-5 mt-8 inquries">
                        ...
                        <form id="enquiryForm">
                            ...
                            <div class="contact-form px-sm-5" dir="rtl">
                                ...
                                <div class="mb-3">
                                    <textarea class="form-control text-start" placeholder="{{ __('messages.form.type_message') }}" name="message" id="message"
                                        rows="5"></textarea>
                                </div>
                                @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                    <div class="mb-3">
                ...
                <div class="vcard-bars-btn position-relative @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if(getLanguage($vcard->default_language) == 'Arabic') sub-btn-div-left @endif">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share)  ? 'vcard4-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                                ...
                                <div class="modal-content animate-bottom" id="newsLatter-content">
                                    ...
                                    <input type="hidden" name="vcard_id" value="{{ $vcard->id }}">
                                        <div class="input-group mb-3 mt-5 border-none">
                                            <input type="email" class="form-control bg-dark border-dark text-light" placeholder="{{ __('messages.form.enter_your_email') }}" name="email" id="emailSubscription aria-label="Email" aria-describedby="button-addon2">
