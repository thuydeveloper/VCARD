    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section pt-60 pb-60 px-30">
                ...
                <div class="card d-flex flex-sm-row"  @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="card-img">
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-6 mb-20">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard24/email.png') }}" loading="lazy"/>
                                    </div>
                        ...
                        @if ($vcard->phone)
                            <div class="col-sm-6 mb-20">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard24/phone.png') }}" loading="lazy"/>
                                    </div>
                                    <div class="contact-desc">
                        ...
                        @if ($vcard->dob)
                            <div class="col-sm-6 mb-sm-0 mb-20">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard24/dob.png') }}" loading="lazy"/>
                                    </div>
                                    <div class="contact-desc">
                        ...
                        @if ($vcard->location)
                            <div class="col-sm-6">
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center">
                                        <img src="{{ asset('assets/img/vcard24/location.png') }}" loading="lazy"/>
                                    </div>
                                    <div class="contact-desc">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-60 pb-50 px-30">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-3 pb-5">
                        <div class="bag-img">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-60 pb-50">
                        <div class="clip-img">
                        ...
                        <div class="testimonial-slider">
                            @foreach ($vcard->testimonials as $testimonial)
                                <div class="">
                                    <div
                                        class="testimonial-card card d-flex flex-sm-row-reverse flex-column justify-content-center" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60 pb-60 px-3">
                            ...
                            @foreach ($vcard->blogs as $blog)
                                <div class="">
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body p-0">
                                            <h2 class="fs-6 fw-6 text-black blog-head text-start">{{ $blog->title }}
                                            </h2>
                                        </div>
                                    </div>
                                </div>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                ...
                @endphp
                    <div class="business-hour-section pt-60 px-30 mb-5">
            ...
            <div class="">
                <div class="create-vcard-section pt-20">
                    <div class="notes-img">
            ...
            @if ($vcard->enable_contact)
                ...
                <div class="add-to-contact-section">
                    <div class="text-center" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <a href="{{ route('add-contact', $vcard->id) }}" class="btn btn-cyan add-contact-btn rounded"><i
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    ...
                    <div class="bars-btn school-bars-btn @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                        <img src="{{ asset('assets/img/vcard24/sticky.png') }}" loading="lazy"/>
                    </div>
                    @endif
