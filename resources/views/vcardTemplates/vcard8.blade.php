...
<body>
    <div class="container p-0">
        ...
        @endif
        <div class="vcard-eight main-content w-100 mx-auto overflow-hidden content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="vcard-eight__banner w-100 position-relative">
                ...
                <video height="400px" class="cover-video img-fluid banner-image position-relative" loop autoplay muted playsinline  alt="background video" id="cover-video">
            ...
            <div>
                ...
                @if(getLanguage($vcard->default_language) == 'Arabic')
                <div
                    class="vcard-eight__profile d-flex align-items-center px-4 flex-sm-row flex-column position-relative" dir="rtl">
                    <div class="vcard-eight__avatar">
                        <img src="{{ $vcard->profile_url }}" class="rounded-circle" loading="lazy"/>
                    </div>
                    <div class="vcard-eight__position d-flex flex-column mx-4 position-relative">
