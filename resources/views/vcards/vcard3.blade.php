...
<div class="container">
    <div class="vcard-three main-content w-100 mx-auto overflow-hidden">
        ...
        <div class="vcard-three__banner w-100 position-relative">
            <img src="{{asset('assets/img/vcard3/vcard3-banner.png')}}" class="img-fluid banner-image" alt="banner" loading="lazy"/>
        ...
        <div class="vcard-three__profile position-relative">
            <div class="avatar position-absolute top-0 start-50 translate-middle">
                <img src="{{asset('assets/img/vcard3/vcard3-profile.png')}}" alt="profile-img" class="rounded-circle" loading="lazy"/>
            </div>
        </div>
        {{--profile details--}}
        ...
        <div class="vcard-three__event py-3 px-3 mt-2 position-relative">
            <img src="{{asset('assets/img/vcard3/vcard3-shape.png')}}" alt="shape" class="position-absolute end-0 shape-one" loading="lazy"/>
            <div class="container">
                <div class="row g-3">
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                <img src="{{asset('assets/img/vcard3/vcard3-email.png')}}" alt="email" loading="lazy"/>
                            </span>
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                <img src="{{asset('assets/img/vcard3/vcard3-phone.png')}}" alt="phone" loading="lazy"/>
                            </span>
                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                <img src="{{asset('assets/img/vcard3/vcard3-birthday.png')}}" alt="birthday" loading="lazy"/>
                            </span>
                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card event-card p-2 h-100 border-0 flex-sm-row flex-column align-items-center">
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                <img src="{{asset('assets/img/vcard3/vcard3-location.png')}}" alt="location" loading="lazy"/>
                            </span>
                            <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
        ...
        <div class="vcard-three__service py-4 position-relative px-sm-3">
            <img src="{{asset('assets/img/vcard3/vcard3-shape2.png')}}" alt="shape" class="position-absolute start-0 shape-two" loading="lazy"/>
            <img src="{{asset('assets/img/vcard3/vcard3-shape3.png')}}" alt="shape" class="position-absolute end-0 bottom-0 shape-three" loading="lazy"/>
            <div class="container">
                    ...
                    <div class="col-sm-6 col-12">
                        <div class="card service-card p-3 h-100 d-flex align-items-center bg-white">
                            <div class="service-image d-flex justify-content-center align-items-center">
                                <img src="{{asset('assets/img/vcard3/vcard3-service1.png')}}" alt="service" loading="lazy"/>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="card testimonial-card p-3 border-0 w-100">
                            <div class="testimonial-user d-flex flex-sm-row flex-column align-items-center justify-content-sm-start justify-content-center">
                                <img src="{{asset('assets/img/vcard3/testimonial-profile.png')}}" alt="profile" class="rounded-circle" loading="lazy"/>
                                <div class="user-details d-flex flex-column ms-sm-3 mt-sm-0 mt-2">
                                    <span class="user-name text-white text-sm-start text-center">Shane Watson</span>
                                    <span class="user-designation text-white text-sm-start text-center">- CEO at Tarsons</span>
                                </div>
        ...
        <div class="vcard-three__qr-code py-4 position-relative px-sm-3">
            <img src="{{asset('assets/img/vcard3/vcard3-shape3.png')}}" alt="shape" class="position-absolute start-0 top-0" loading="lazy"/>
            <div class="container">
                ...
                <div class="card qr-code-card flex-sm-row flex-column justify-content-center align-items-center px-sm-3 px-4 py-md-5 py-4 mt-3">
                    <div class="qr-profile mb-3 d-flex justify-content-center d-sm-none d-block">
                        <img src="{{asset('assets/img/vcard3/testimonial-profile.png')}}" alt="qr profile" class="rounded-circle" loading="lazy"/>
                    </div>
                    <div class="qr-code-scanner mx-md-4 mx-2 p-4 bg-white">
                        <img src="{{asset('assets/img/vcard3/vcard3-qr-code.png')}}" alt="qr profile" loading="lazy"/>
                    </div>
                    <div class="mx-2">
        ...
        <div class="vcard-three__timing py-4 position-relative px-sm-3">
            <img src="{{asset('assets/img/vcard3/vcard3-shape.png')}}" alt="shape"
                 class="position-absolute end-0 shape-four" loading="lazy"/>
            <div class="container">
        ...
        <div class="vcard-three__contact py-4 position-relative">
            <img src="{{asset('assets/img/vcard3/vcard3-shape3.png')}}" alt="shape" class="position-absolute start-0 bottom-0" loading="lazy"/>
            <div class="container">
                <h4 class="vcard-three-heading heading-line position-relative text-center">Inquiries</h4>
                <div class="row mt-4">
                    <div class="col-12">
