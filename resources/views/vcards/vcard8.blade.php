    ...
    <div class="vcard-eight main-content w-100 mx-auto overflow-hidden">
        ...
        <div class="vcard-eight__profile d-flex align-items-center px-4 flex-sm-row flex-column position-relative">
            <div class="vcard-eight__avatar">
                <img src="{{asset('assets/img/vcard8/vcard8-profile.png')}}" class="rounded-circle" loading="lazy"/>
            </div>
                ...
                <div class="col-12">
                    <div class="card event-card p-4">
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                                    <img src="{{asset('assets/img/vcard8/vcard8-phone.png')}}" alt="mobile" loading="lazy"/>
                                </div>
                                <div class="event-details">
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                                    <img src="{{asset('assets/img/vcard8/vcard8-birthday.png')}}" alt="birthday" loading="lazy"/>
                                </div>
                                <div class="event-details">
                            ...
                            <div class="col-sm-6 col-12">
                                <div class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                                    <img src="{{asset('assets/img/vcard8/vcard8-location.png')}}" alt="location" loading="lazy"/>
                                </div>
                                <div class="event-details">
                    ...
                    <div class="col-sm-6 col-12 p-3">
                        <div class="card service-card px-3 py-0 h-100 border-0">
                            <div class="service-image d-flex justify-content-center align-items-center rounded-circle">
                                <img src="{{asset('assets/img/vcard3/vcard3-service1.png')}}" alt="UI/UX" loading="lazy"/>
                            </div>
        ...
        <div class="vcard-eight__contact py-4 position-relative px-sm-4 px-3">
            <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">Inquiries</h4>
            <div class="container">
                <div class="row mt-4">
