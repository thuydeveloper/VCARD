    ...
    <div class="row d-flex justify-content-center">
        <div class="main-bg p-0">
            <div class="head-img position-relative">
                <img src="{{asset('assets/img/vcardnew-bg.png')}}" height="400px" class="img-fluid" loading="lazy"/>
                    ...
                    <div class="row">
                        <div class="col-sm-6 pb-4">
                            <div class="about-details">
                                <img src="{{asset('assets/img/aboutemail.png')}}" class="mb-2" loading="lazy"/>
                                <p class="about-title mb-0">sly.watson@gmail.com</p>
                            </div>
                        </div>
                        <div class="col-sm-6 pb-4">
                            <div class="about-details">
                                <img src="{{asset('assets/img/aboutcake.png')}}" class="mb-2" loading="lazy"/>
                                <p class="about-title mb-0">30 October 1997</p>
                            </div>
                        </div>
                        <div class="col-sm-6 pb-4">
                            <div class="about-details">
                                <img src="{{asset('assets/img/aboutcall.png')}}" class="mb-2" loading="lazy"/>
                                <p class="about-title mb-0">+ 91 99746 99793</p>
                            </div>
                        </div>
                        <div class="col-sm-6 pb-4">
                            <div class="about-details">
                                <img src="{{asset('assets/img/aboutlocation.png')}}" class="mb-2" loading="lazy"/>
                ...
                <div class="main-our-service mb-4">
                    ...
                    <div class="row">
                        <div class="col-12 mb-4">
                            <div class="service-info d-flex align-items-center">
                                <div class="service-img me-3 rounded-circle">
                                    <img src="{{asset('assets/img/s1.png')}}" loading="lazy"/>
                                </div>
                                <div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="service-info d-flex align-items-center">
                                <div class="service-img me-3 rounded-circle">
                                    <img src="{{asset('assets/img/s2.png')}}" loading="lazy"/>
                                </div>
                                <div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="service-info d-flex align-items-center">
                                <div class="service-img me-3 rounded-circle">
                                    <img src="{{asset('assets/img/s3.png')}}" loading="lazy"/>
                                </div>
                                <div>
                        ...
                        <div class="col-12 mb-4">
                            <div class="service-info d-flex align-items-center">
                                <div class="service-img me-3 rounded-circle">
                                    <img src="{{asset('assets/img/s4.png')}}" loading="lazy"/>
                                </div>
                                <div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-center mb-4">
                            <img src="{{asset('assets/img/newqr.png')}}" class="qr-img" loading="lazy"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="container py-4">
                <h2 class="contact-heading mb-4 text-center">Inquiries</h2>
