        ...
        <div class="row d-flex justify-content-center content-blur">
            <div class="main-bg p-0 collapse show allSection">
                ...
                <div class="main-banner position-relative">
                    ...
                    @else
                    <img src="{{ $vcard->cover_url }}" class="banner-img" loading="lazy"/>
                    @endif
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    <div class="user-profile">
                                        <img src="{{ $vcard->profile_url }}" class="img-fluid rounded-circle" loading="lazy"/>
                                    </div>
                                    <div class="ms-3">
                                        <h4 class="big-title">
                                        ...
                                        <div class="col-12 px-4">
                                            <div class="card shadow-testi w-100 border-0 p-sm-4 p-3">
                                                <div class="card-body p-0">
                                                    <div class="d-flex align-items-center testimonial-box" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                ...
                @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                    @if (checkFeature('blog') && $vcard->blogs->count())
                        <div class="container vcard-seven-blog my-5 pb-1">
                ...
                @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                    @if ($vcard->businessHours->count())
                        ...
                        @endphp
                        <div class="container my-5 pt-4"  @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
