...
<body>
    <div class="container main-section px-0  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
        ...
        <div class="">
            <div class="main-bg p-0 collapse show allSection">
                ...
                <div class="head-img position-relative">
                    ...
                    <video height="400px" class="cover-video" loop autoplay muted playsinline  alt="background video" id="cover-video">
                                        ...
                                        <div class="card text-center testi-shadow w-100">
                                            ...
                                            <div class="card-body p-0">
                                                <div class="row d-flex justify-content-between align-items-end">
                                                    <div class="col-lg-6">
                                                        <div class="d-flex align-items-center" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                                            <img src="{{ $testimonial->image_url }}"
                                                                class="me-3 testi-logo rounded-circle ms-2" loading="lazy"/>
            ...
            <nav>
                ...
                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                    <button class="d-flex align-items-center justify-content-center active postbtn instagram-btn fs-2 py-2" id="nav-home-tab"
                    ...
                    <button class="d-flex align-items-center justify-content-center instagram-btn reelsbtn fs-2  py-2" id="nav-profile-tab" data-bs-toggle="tab"
                                ...
                                <div class="col-sm-6">
                                    <div class="row">
                                        <label for="basic-url"
                                            class="form-label mb-0">{{ __('messages.user.your_name') }} <span class="text-danger">*</span></label>
                                        <div class="col-12 mb-3 input-group">
                                            <span class="input-group-text bg-white contact-input border-start-0"
                                                id="basic-addon1"><i class="far fa-user"></i></span>
                                            <input type="text" name="name"
                                                class="form-control contact-input border-end-0 text-start" id="name"
                                                placeholder="{{ __('messages.form.your_name') }}">
                                        </div>
                                        ...
                                        <div class="col-12 mb-3 input-group">
                                            <span class="input-group-text bg-white contact-input border-start-0"
                                                id="basic-addon1"><i class="far fa-envelope"></i></span>
                                            <input type="email" name="email"
                                                class="form-control contact-input border-end-0 text-start" id="email"
                                                placeholder="{{ __('messages.form.your_email') }}">
                                        </div>
                                        ...
                                        <div class="col-12 mb-3 input-group">
                                            <span class="input-group-text bg-white contact-input border-start-0"
                                                id="basic-addon1"><i class="fas fa-phone"></i></span>
                                            <input type="tel" name="phone"
                                                class="form-control contact-input border-end-0 text-start" id="phone"
                                                placeholder="{{ __('messages.form.phone') }}">
                                        </div>
                                    </div>
                                </div>
