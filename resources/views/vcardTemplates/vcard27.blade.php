        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="banner-section position-relative bg-white">
                <div class="banner-img">
                    ...
                    @else
                        <img src="{{ $vcard->cover_url }}" class="banner-img object-fit-cover w-100 h-100"
                            loading="lazy" />
                    @endif
                </div>
            ...
            {{-- profile detail --}}
            <div class="profile-section pt-sm-4 pb-60 px-30">
                @if(getLanguage($vcard->default_language) != 'Arabic')
                <div class="card d-flex flex-sm-row-reverse align-items-sm-start align-items-center mb-30">
                ...
                @endif
                @if(getLanguage($vcard->default_language) == 'Arabic')
                <div class="card d-flex flex-sm-row-reverse align-items-sm-start align-items-center mb-30" dir="rtl">
                    <div class="card-img bg-white">
                        <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover" loading="lazy" />
                    </div>
                    <div class="card-body p-0 text-sm-start text-center">
                ...
                @endif
                <div class="text-light text-sm-start text-center profile-desc">
            ...
            <div class="contact-section pt-30 pb-30 px-30">
                ...
                @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                    ...
                    <div class="row">
                            ...
                            @if ($vcard->location)
                                <div class="contact-box d-flex align-items-center">
                                    <div class="contact-icon d-flex justify-content-center align-items-center bg-pink">
                                        <img src="{{ asset('assets/img/vcard27/location.png') }}" alt="" />
                                    </div>
                                    <div class="contact-desc">
                        ...
                        @endif
                        @if(getLanguage($vcard->default_language) == 'Arabic')
                        <div class="col-sm-6 mb-sm-0 mb-4" dir="rtl">
                            @if ($vcard->email)
                                <div class="contact-box d-flex align-items-center mb-3">
                                    <div
                                        class="contact-icon d-flex justify-content-center align-items-center bg-orange">
                                            ...
                                            <div
                                                ...
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    ...
                                                    <img src="{{ $service->service_icon }}" alt="branding"
                                                        loading="lazy" class="service-img w-100 object-fit-cover" />
                                                </a>
                                            </div>
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-30 pb-60 px-30">
                        ...
                        <div class="appointment">
                            <div class="mb-30">
                                <label for="date"
                                    class="appoint-date text-black text-start fs-18 mb-1">{{ __('messages.date') }} :</label>
                                <div class="row">
                                    <div class="col-12">
                            ...
                            <div class="">
                                <label class="text-black text-start fs-18 mb-10">{{ __('messages.hour') }} :</label>
                                <div class="">
                                    <div id="slotData" class="row ">
                                    </div>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="appointmentAdd btn btn-secondary w-100">
                                    ...
                                    <div class="product-card card">
                                        ...
                                        <div class="product-desc card-body p-3">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                ...
                                                <p class="amount fs-18 mb-0 text-secondary">
                                                    @if ($product->currency_id && $product->price)
                                                        <span
                                                            class="fs-18 text-secondary">{{ $product->currency->currency_icon }}{{ number_format($product->price, 2) }}</span>
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs border-0 px-0" id="nav-tab" role="tablist">
                                    ...
                                    <button class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn  border-0 text-dark mr-0"
                            ...
                            <div class="business-hour-card row justify-content-center">
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6 mb-3">
                                        <div class="business-hour" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                            <span
                                                class="">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) }}
                                                : </span>
                        ...
                        <form action="" id="enquiryForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 text-center">
                                    <button class="send-btn rounded-2 btn btn-secondary contact-btn" type="submit">
            ...
            <div class="btn-section cursor-pointer @if(getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($userSetting['hide_stickybar']))
                        <div class="bars-btn pet-shop-bars-btn @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                ...
                <div class="modal-body">
                    ...
                    <a href="http://pinterest.com/pin/create/link/?url={{ $shareUrl }}" target="_blank"
                        ...
                        <div class="row">
                            ...
                            <div class="col-1 p-1">
                                <svg xmlns="http://www.w3.org/2000/svg" class="arrow" class="arrow" version="1.0" height="16px"
                                    viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
                                    <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)"
                                        fill="#000000" stroke="none">
                                        <path
