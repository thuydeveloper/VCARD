    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-40">
                ...
                @endif
                @if(getLanguage($vcard->default_language) == 'Arabic')
                <div class="card d-flex flex-sm-row  align-items-center" dir="rtl">
                    <div class="card-img me-sm-4">
                        <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover" loading="lazy"/>
                    </div>
                    <div class="card-body">
                ...
                <div class="text-gray-100 profile-desc mb-40 fs-14 text-center">
                    {!! $vcard->description !!}
                </div>
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-6 mb-40">
                                    <div class="contact-box d-flex align-items-start">
                                        <div class="contact-icon mt-2 d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('assets/img/vcard19/email-icon.png') }}" alt="" loading="lazy">
                                        </div>
                                        <div class="contact-desc">
                                            <a href="mailto:{{ $vcard->email }}"
                                                class="text-primary fs-12 fw-5">{{ $vcard->email }}</a>
                                            <p class="mb-0 fs-12 text-black">{{ __('messages.admin.email') }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="col-sm-6 mb-40">
                                    <div class="contact-box d-flex align-items-start">
                                        <div class="contact-icon mt-2 d-flex justify-content-center align-items-start">
                                            <img src="{{ asset('assets/img/vcard19/email-icon.png') }}"
                                                alt="">
                                        </div>
                                        <div class="contact-desc">
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6 mb-40">
                                    <div class="contact-box d-flex align-items-start">
                                        <div class="contact-icon mt-2 d-flex justify-content-center align-items-start">
                                            <img src="{{ asset('assets/img/vcard19/phone-icon.png') }}"
                                                alt="">
                                        </div>
                                        <div class="contact-desc">
                                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}"
                                                class="text-primary fs-14 fw-5">+{{ $vcard->region_code }}{{ $vcard->phone }}</a>
                                            <p class="text-black fs-12 mb-0">{{ __('messages.vcard.mobile_number') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section pt-30 px-40 pb-3">
                        <div class="gallery-bg-img">
                            <img src="{{ asset('assets/img/vcard19/gallery-bg-img.png') }}" loading="lazy"/>
                        </div>
                                        ...
                                        <div class="service-card h-100">
                                            <div
                                                ...
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    class="text-decoration-none"
                                                    target="{{ $service->service_url ? '_blank' : '' }}">
                                                    <img src="{{ $service->service_icon }}" class="w-100" loading="lazy"/>
                                                </a>
                                            </div>
                                            <div class="card-body text-center p-0 pt-2">
                                                <h3 class="card-title fs-18 text-black">{{ ucwords($service->name) }}
                                                </h3>
                                                <p
                ...
                <div class="mt-5 px-40">
                    ...
                    <nav>
                        ...
                        <div class="nav nav-tabs border-0 px-0" id="nav-tab" role="tablist">
                            ...
                            <button class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn border-0 text-dark" id="nav-profile-tab"
                            ...
                            @foreach ($vcard->blogs as $blog)
                                <div class="">
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body p-0" style="min-height:auto!important">
                                            <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                                                <h2 class="fs-20 p-2 text-primary text-center">{{ $blog->title }}
                                                </h2>
                                            </a>
                                        </div>
                                    </div>
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60 px-40">
                    ...
                    <div class="qr-code d-flex justify-content-center flex-wrap mb-40"  @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        <div class="qr-profile-img">
                            <img src="{{ $vcard->profile_url }}" class="w-100 h-100 object-fit-cover rounded-3" loading="lazy"/>
                        </div>
                                ...
                                <div class="iframe-card card mx-10" style="max-width: none">
                                    <div class="overlay">
                                        <iframe src="{{ $iframe->url }}" frameborder="0"
                                            ...
                                            allowfullscreen width="100px" height="400" class="iframe-body" loading="lazy">
                                        </iframe>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="add-to-contact-section mb-4">
                @if ($vcard->enable_contact)
                    <div class="d-flex justify-content-center align-items-center" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div class="bars-btn fashion-bars-btn  @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard19/sticky.png') }}" loading="lazy"/>
                        </div>
                    @endif
       ...
       <div class="modal-dialog news-modal">
           <div class="modal-content animate-bottom" id="newsLatter-content">
               <div class="newsmodal-header">
                   <button type="button" class="btn-close p-4 position-absolute top-0 end-0" data-bs-dismiss="modal"
               ...
               <div class="modal-body">
                   ...
                   <div class="input-group mb-3 mt-5">
                       <input type="email" class="text-light form-control  bg-dark border-dark " placeholder="{{ __('messages.form.enter_your_email') }}" aria-label="Email" name="email" id="emailSubscription" aria-describedby="button-addon2">
