	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				...
				<button type="button" class="btn-close m-0 @if(getLogInUser()->language == 'ar') m-0 @endif" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
			<div class="modal-body pb-0 pt-2">
				<div>
                    ...
                    <div class="row py-3">
						<h5 class="col-5">{{ __('messages.payment_type') }} </h5>
