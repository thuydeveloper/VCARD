...
<body>
    <div class="container p-0">
        ...
        @endif
        <div class="vcard-nine main-content w-100 mx-auto overflow-hidden content-blur allSection  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            {{-- support banner --}}
                            ...
                            @if ($vcard->alternative_phone)
                                <div class="col-sm-6 col-12">
                                    <div
                                        class="card event-card px-3 py-4 h-100 border-0 flex-sm-row flex-column align-items-center">
                                        <span class="event-icon d-flex justify-content-center align-items-center">
                                            <img src="{{ asset('img/vcard9/alter-phone.png') }}" alt="phone" />
                                        </span>
                                        <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                            <h6 class="text-sm-start text-center">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="vcard-nine__qr-code py-4 px-3 position-relative px-sm-3 my-5">
                    ...
                    <div class="container mt-5">
                        ...
                        @if(getLanguage($vcard->default_language) == 'Arabic')
                        <div
                            class="card qr-code-card flex-sm-row flex-column justify-content-center align-items-center mt-3 border-0" dir="rtl">
                            <div class="mx-2">
                                <div class="qr-profile mb-3 d-flex justify-content-center">
                                    <img src="{{ $vcard->profile_url }}" alt="qr profile"
                                        class="mx-auto d-block rounded-circle" loading="lazy"/>
                                        ...
                                        <div class="card blog-card p-2 border-0 w-100 h-100">
                                            ...
                                            <div class="blog-details p-3">
                                                <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}"
                                                    class="text-decoration-none">
                                                    <h4
                                                        class="text-sm-start text-center title-color p-3 mb-0 text-black">
                                                        {{ $blog->title }}</h4>
                                                </a>
                                            </div>
                                        </div>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="vcard-nine__appointment py-3 px-sm-4 px-3 mt-2 position-relative mb-10 mt-0">
                        <h4 class="heading-left heading-line position-relative text-center mb-10">
                            ...
                            <div class="col-12 px-0">
                                <form id="enquiryForm">
                                    ...
                                    <div class="contact-form px-sm-2" dir="rtl">
                                        ...
                                        <div class="mb-3">
                                            <input type="tel" name="phone" class="form-control text-start" id="mobile"
                                                placeholder="{{ __('messages.form.phone') }}">
                                        </div>
                                        <div class="mb-3">
                ...
                <div class="vcard-bars-btn position-relative @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div @if(getLanguage($vcard->default_language) == 'Arabic') sub-btn-div-left @endif">
                            ...
                            @if (empty($vcard->hide_stickybar))
                                <div
                                    class="{{ isset($vcard->whatsapp_share) ? 'vcard9-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
