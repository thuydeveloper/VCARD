    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section pb-40  bg-primary">
                ...
                <div class="desc px-30 text-gray-100 text-start">
                    <p class=" mb-0">
                        {!! $vcard->description !!}
                    </p>
                </div>
            ...
            <div class="contact-section  pt-40">
                <div class="section-heading left-heading mb-3">
                ...
                <div class="row align-items-end px-sm-0 px-30">
                    ...
                    <div class="col-sm-6">
                        ...
                        @endif
                        @if(getLanguage($vcard->default_language) == 'Arabic')
                        <div class="row mb-sm-0 mb-4" dir="rtl">
                            <div class="col-12 mb-10">
                                {{-- email --}}
                                @if ($vcard->email)
                                    <div class="contact-box d-flex align-items-center">
            ...
            @if (checkFeature('gallery') && $vcard->gallery->count())
                <div class="gallery-section bg-primary position-relative pt-60 pb-60">
                    ...
                    <div class="row h-100 align-items-center flex-sm-row flex-column-reverse pt-sm-0 pt-60">
                                                ...
                                                <div class="gallery-img img-2 ms-sm-auto me-sm-0 mx-auto">
                                                    <a href="{{ $file->gallery_image }}"
                                                        data-lightbox="gallery-images"><img
                                                            ...
                                                            class="img-fluid h-100 object-fit-cover w-100" loading="lazy"/></a>
                                                </div>
                        ...
                        <div class="col-sm-6 overflow-hidden px-0">
            ...
            <div class="insta-section pt-5 bg-gray-200">
                    <div class="section-heading right-heading mb-5">
                        <h2 class="bg-primary text-white">
            ...
            @if (checkFeature('blog') && $vcard->blogs->count())
                <div class="blog-section mt-4 pb-50 bg-gray-200">
                    <div class="section-heading right-heading pb-3 ">
                        <h2 class="bg-primary text-white">
                    ...
                    <div class="blog-slider px-4">
                        @foreach ($vcard->blogs as $blog)
                            <div class="">
                                <div class="blog-card card flex-sm-row align-items-center" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                    <div class="card-img">
                    ...
                    <div class="blog-bg">
                        <img src="{{ asset('assets/img/vcard16/blog-bg-img.png') }}" loading="lazy">
                    </div>
                </div>
            @endif
            @endif
            ...
            @if (checkFeature('iframes') && $vcard->iframes->count())
                <div class="iframe-section pt-20 pb-20 mt-4">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pb-30 mt-5">
                    <div class="section-heading right-heading pb-40">
                        <h2 class="bg-primary text-white">
                    ...
                    @endif
                    @if(getLanguage($vcard->default_language) == 'Arabic')
                    <div class="contact-form  px-30 position-relative" dir="rtl">
                        <form action="" id="enquiryForm">
                            @csrf
                            <div class="row">
                                <div id="enquiryError" class="alert alert-danger d-none"></div>
            ...
            @if ($vcard->enable_contact)
                <div class="add-to-contact-section py-3 px-30 text-center">
                    <div class="d-inline-block" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            <div class="btn-section cursor-pointer @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div class="bars-btn lawyer-bars-btn @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
                            <img src="{{ asset('assets/img/vcard16/sticky.png') }}" loading="lazy"/>
                        </div>
                    @endif
