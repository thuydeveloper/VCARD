    ...
    <div class="container p-0">
        <div class="product-details-page main-content  w-100 mx-auto content-blur allSection collapse show">
            ...
            <div class="py-3 mb-10 mt-0">
                <div class="row mt-2 mb-3" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="col-9">
                        <h2 class="text-primary fw-bold text-start ms-3 @if(getLanguage($vcard->default_language) == 'Arabic') text-end @endif ">{{ __('messages.plan.products') }}</h2>
                    </div>
                    <div class="col-3">
                        <a class="btn vcard-13-btn text-decoration-none" href="{{ route('vcard.show', ['alias' => $vcard->url_alias]) }}"
                                ...
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card p-2 w-75 h-100">
                                        ...
                                        @if (!empty($product->price))
                                            ...
                                            <button class="btn vcard-13-btn text-decoration-none rounded-2 buy-product" data-id="{{ $product->id }}">{{ __('messages.subscription.buy_now') }}</button>
                                            </div>
                                        @endif
                                        </div>
                                    </div>
