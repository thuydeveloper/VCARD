        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @if (isset($appointmentDetail->is_paid) &&
                    ...
                    <div class="mt-3">
                        {{ Form::label('phone', __('messages.common.price') . ':', ['class' => 'form-label']) }} <span
                            class="form-label"
                            id="paymentCurrencyCode">{{ getCurrencyAmount(number_format($appointmentDetail->price), $currency->currency_icon) }}</span>
