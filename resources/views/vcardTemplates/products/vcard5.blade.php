            ...
            <div class="vcard-one__product py-3 mb-10 mt-0 main-bg h-100">
                <div class="row justify-content-between"  @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="col-4 mt-6 text-center">
                        <a class="product-btn rounded-2 text-white text-decoration-none" href="{{ route('vcard.show', ['alias' => $vcard->url_alias]) }}"
                                    ...
                                    <div class="card product-card p-2 border-0 h-100">
                                        <div class="product-profile d-flex justify-content-center">
                                            <img src="{{ $product->product_icon }}" alt="profile"
                                                class="object-fit-contain mt-3" height="208px" loading="lazy"/>
                                        </div>
