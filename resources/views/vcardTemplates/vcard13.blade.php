        ...
        <div class="main-content mx-auto w-100 overflow-hidden @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-30">
                ...
                <div class="card d-flex flex-sm-row-reverse align-items-sm-end align-items-center justify-content-end">
                    <div class="card-img d-flex justify-content-center align-items-center">
                        <img src="{{ $vcard->profile_url }}" class="img-fluid banner-image" alt="banner" loading="lazy"/>
                    </div>
                ...
                @endif
                @if(getLanguage($vcard->default_language) == 'Arabic')
                <div class="card d-flex flex-sm-row-reverse align-items-sm-end align-items-center justify-content-end" dir="rtl">
                    <div class="card-img d-flex justify-content-center align-items-center">
                        <img src="{{ $vcard->profile_url }}" class="img-fluid banner-image" alt="banner" loading="lazy"/>
                    </div>
                    <div class="card-body pb-0 px-0">
                                ...
                                <div class="col-sm-6 mb-40">
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <p class="text-white mb-0 fs-14">{{ __('messages.admin.email') }}
                                            </p>
                            ...
                            @if ($vcard->phone)
                                <div class="col-sm-6 mb-40">
                                    <div class="contact-box d-flex align-items-center">
                                        ...
                                        <div class="contact-desc">
                                            <p class="text-white mb-0 fs-14">{{ __('messages.vcard.mobile_number') }}
                                            </p>
                                ...
                                <div class="">
                                    ...
                                    <div class="product-card card">
                                        <div class="product-img card-img">
                                            <img src="{{ $product->product_icon }}" class="img-fluid h-100 object-fit-contain" loading="lazy"/>
                                        </div>
                    ...
                    <div class="testimonial-slider">
                        @foreach ($vcard->testimonials as $testimonial)
                            <div class="px-sm-4 px-3">
                                <div
                                    class="testimonial-card d-sm-flex justify-content-sm-start justify-content-center align-items-center" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            <div class="my-5">
                ...
                <nav>
                    ...
                    <div class="nav nav-tabs px-0 border-0" id="nav-tab" role="tablist">
                        <button class="d-flex align-items-center justify-content-center py-2 active postbtn instagram-btn text-dark border-0" id="nav-home-tab"
                        ...
                        <button class="d-flex align-items-center justify-content-center py-2 instagram-btn reelsbtn text-dark border-0" id="nav-profile-tab"
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pb-40 mb-4">
                        <div class="section-heading text-center mb-3 pb-3 px-4 mt-5">
                            <h2 class="text-primary mb-0 fw-bold">{{ __('messages.feature.blog') }}</h2>
                        </div>
                        <div class="blog-slider px-4">
                            @foreach ($vcard->blogs as $blog)
                                <div class="">
                                    <div class="blog-card mb-sm-0 mb-5 d-flex flex-sm-row-reverse flex-column-reverse" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                        <div class="card-img">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    <div class="bussiness-hour-section pt-40 pb-40">
                        ...
                        <div class="px-30">
                            <div class="bussiness-hour-card"  @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section py-3 px-sm-4 px-3 mt-2 position-relative mb-10 mt-0">
                        <h4 class="heading-left heading-line position-relative text-center mb-4 fw-bold text-primary">
            ...
            <div class="contact-us-section pt-30 px-sm-4 px-3 mt-5 bg-primary-light mb-4">
                    ...
                    <form id="enquiryForm">
                        ...
                        <div class="row m-sm-0">
                            ...
                            <div class="col-12 text-center mt-4 w-100">
                                <button class="contact-btn btn vcard-13-btn p-2 w-50 w-sm-100 mb-4" type="submit">
                ...
                @endif
                @if(getLanguage($vcard->default_language) == 'Arabic')
                <div class="contact-form px-sm-4 px-3" dir="rtl">
                    <form id="enquiryForm">
                        @csrf
                        <div class="row m-sm-0">
                            <div id="enquiryError" class="alert alert-danger d-none"></div>
            ...
            <div class="btn-section cursor-pointer @if(getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
                <div class="fixed-btn-section">
                    @if (empty($vcard->hide_stickybar))
                        <div class="bars-btn hospital-bars-btn @if(getLanguage($vcard->default_language) == 'Arabic') vcard-bars-btn-left @endif">
