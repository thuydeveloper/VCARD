    ...
    <div class="container-fluid">
        <div class="d-md-flex align-items-center justify-content-between mb-5">
            ...
            <div class="text-end mt-4 mt-md-0">
                <a href="{{ route('nfc-card-orders.index') }}">
                    <button type="button"
                            ...
                            <div class="row">
                                ...
                                @if (!@empty($nfcCardOrder->vcard->name))
                                    <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                        ...
                                        <span class="fs-4"><a href="{{ route('vcard.show', ['alias' => $nfcCardOrder->vcard->url_alias]) }}" class="text-decoration-none" target="_blank">{{ $nfcCardOrder->vcard->name }}</a></span>
                                    </div>
                                @endif
                                <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                    <label for="name"
                                ...
                                <div class="col-sm-6 d-flex flex-column mb-md-10 mb-5">
                                    <label for="name"
                                        ...
                                        <img src="{{ $nfcCardOrder->getMedia('nfc_order_logo')->first()->getFullUrl() }}" width="150" height="100" alt="Company Logo" >

                                        <a href="{{ route('nfc.download.logo', ['id' => $nfcCardOrder->id]) }}" class="btn btn-primary mt-2" style="width:150px">
