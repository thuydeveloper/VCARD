        ...
        <div class="vcard-eighteen bg-light main-content mx-auto w-100 overflow-hidden border">
            ...
            <div class="vcard-one__product py-3 mb-10 mt-0">
                <div class="row justify-content-between" @if(getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <div class="col-4">
                        <h4 class="vcard-prodcut-heading fw-500 fs-1 p-2 text-primary">{{ __('messages.vcard.products') }}</h4>
                    </div>
                    <div class="col-4 mt-20 p-4 text-center">
                        <a class="vcard-eighteen-btn text-white bg-primary text-decoration-none" href="{{ route('vcard.show', ['alias' => $vcard->url_alias]) }}"
                                ...
                                <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                    ...
                                    <div class="card product-card border w-75 h-100">
                                        <div class="d-flex justify-content-center mt-1">
                                            <img src="{{ $product->product_icon }}" alt="profile" class="w-50 object-fit-contain mt-2"
